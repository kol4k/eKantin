...
--
-- Host: 127.0.0.1
-- Generation Time: 28 Nov 2017 pada 01.27
...
CREATE TABLE `products` (
  ...
  `id_category` int(10) UNSIGNED NOT NULL,
  `condition` enum('new','old') COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `id_class` int(10) UNSIGNED ZEROFILL DEFAULT NULL,
...
(2, 'Mochammad Rafi Al Rizkan', 'rafinyadi@gmail.com', '1002002', 'd41d8cd98f00b204e9800998ecf8427e', NULL, NULL, 2, NULL, NULL, NULL, NULL);
